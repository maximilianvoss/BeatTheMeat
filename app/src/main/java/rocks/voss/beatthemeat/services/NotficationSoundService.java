...
public class NotficationSoundService extends Service {
    ...
    public void onCreate() {
        ...
        String alarm = sharedPref.getString("alarm_20", null);
        Uri notificationUri;
        if (alarm == null) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this, Constants.NOTIFICIATION_CHANNEL_ID)
                ...
                .setAutoCancel(true)
                .addAction(R.drawable.ic_launcher_foreground, "Dismiss", dismissReceiverPendingIntent)
